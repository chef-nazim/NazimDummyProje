...
{
    public abstract class AbsChefTimer : IChefTimer
    {
        /// <summary>
        ...
        /// </summary>
        public AbsChefTimer(TimerModel timerModel)
        {
            _timerModel = timerModel;
            CLogger.Log(LogState.Game, $"[Timer] Duration: {_timerModel.Duration}");
        ...
        public virtual void Dispose()
        {
            ...
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Dispose");
        }
        ...
        {
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Start");
        ...
        public void Restart()
        {
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Restart");
            _timerModel.IsRunning = false;
            _timerModel.ElapsedTime = 0;
        ...
        {
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Stop");
            _timerModel.IsRunning = false;
            _timerModel.TempDuration = _timerModel.Duration;
            _timerModel.ElapsedTime = 0;
            _loopCount = _timerModel.LoopCount;
        ...
        {
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Pause");
            _timerModel.IsRunning = false;
        }
        ...
        {
            CLogger.Log(LogState.Game, $"[Timer {_timerModel.Id}] Resume");
            _timerModel.IsRunning = true;
        }
        ...
        /// <returns></returns>
        public virtual IChefTimer OnAddExtraDurationTimer(Action<string, float, float, float> onAddExtraDuration)
        {
        ...
        /// </summary>
        public virtual IChefTimer OnCompleteTimer(Action<string> onComplete)
        {
        ...
        /// </summary>
        public virtual IChefTimer OnUpdateTimer(Action<string, float, float> onTick)
        {
            OnUpdate += onTick;
            return this;
        }
        ...
        /// </summary>
        public virtual IChefTimer OnCycleCompleteTimer(Action<string, int> onCycleComplete)
        {

...
namespace gs.chef.onnectnext.timer
{
    ...
    /// </summary>
    public interface IChefTimer : IDisposable
    {
        /// <summary>
        ...
        public IChefTimer OnAddExtraDurationTimer(Action<string, float, float, float> onAddExtraDuration);

        /// <summary>
        /// Sets the OnComplete event and returns the timer.
        /// </summary>
        public IChefTimer OnCompleteTimer(Action<string> onComplete);

        /// <summary>
        /// Sets the OnUpdate event and returns the timer.
        /// </summary>
        public IChefTimer OnUpdateTimer(Action<string, float, float> onTick);

        /// <summary>
        /// Sets the OnCycleComplete event and returns the timer.
        /// </summary>
        public IChefTimer OnCycleCompleteTimer(Action<string, int> onCycleComplete);
    }
}